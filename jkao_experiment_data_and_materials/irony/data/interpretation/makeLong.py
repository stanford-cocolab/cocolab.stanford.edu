...
item_indices = range(5,17)

# Order of the fields
print "workerID,gender,age,income,language,order,imageID,imageCategory,utterance,stateRating,sad,disgusted,angry,neutral,content,happy,excited"
firstline = 0
for l in f:
    if firstline == 0:
        firstline = 1
